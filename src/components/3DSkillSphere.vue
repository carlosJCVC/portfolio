<template>
  ...
  >
    ...
    <div class="relative z-10 p-8">
      ...
      >
        <div class="skill-sphere-container relative h-[400px] w-full">
          ...
          >
            <h4 class="text-lg font-semibold text-blue-600 dark:text-blue-300">
              {{ hoveredSkill.name }}
            </h4>
    ...
    <div
      class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500"
    ></div>
  </div>
</template>
...
const skills = [
  ...
  },
  {
    name: 'Vue.js',
    level: 85,
    description: 'Experienced with Vue 3 and Composition API',
    category: 'Frontend'
  },
  {
    name: 'React',
    level: 80,
    description: 'Solid understanding of React and its ecosystem',
    category: 'Frontend'
  },
  {
    name: 'Node.js',
    level: 85,
    description: 'Strong backend development skills with Express',
    category: 'Backend'
  },
  {
    name: 'Python',
    level: 75,
    description: 'Proficient in data analysis and scripting',
    category: 'Backend'
  },
  {
    name: 'SQL',
    level: 80,
    description: 'Experienced with relational database design',
    category: 'Database'
  },
  {
    name: 'MongoDB',
    level: 70,
    description: 'Familiar with NoSQL database concepts',
    category: 'Database'
  },
  {
    name: 'Docker',
    level: 65,
    description: 'Basic containerization and deployment skills',
    category: 'DevOps'
  },
  {
    name: 'AWS',
    level: 60,
    description: 'Familiarity with cloud services and deployment',
    category: 'DevOps'
  },
  {
    name: 'UI/UX Design',
...
const initSkillSphere = () => {
  ...
  sphereMaterial.value = new THREE.MeshBasicMaterial({
    color: theme.value == 'dark' ? 0xcccccc : 0x333333,
    wireframe: true
  })
