<template>
  <div>
    <p class="text-xl leading-relaxed dark:text-gray-300 text-justify">
      Hello! I'm <span class="font-semibold text-indigo-600 dark:text-indigo-400">Carlos</span>, a
      passionate Full-Stack Developer with over 7 years of experience, specializing in developing
      robust web applications using technologies such as Laravel, Vue, Angular, and JavaScript, with
      a strong background in PHP, MySQL, JavaScript, and REST APIs. Proven track record of
      delivering high-quality, scalable solutions. Skilled in both front-end and back-end
      development, with expertise in applying clean code principles and SOLID design patterns.
      Extensive experience in server management, mobile development, and collaborating with clients
      across various industries, offering versatile and results- driven solutions to complex
      challenges and contributing to impactful projects.
    </p>
