              ...
              <div
                ...
                <div v-if="selectedProject">
                  <div class="mt-3 text-center sm:mt-0 sm:text-left">
                    <DialogTitle as="h3" class="text-3xl leading-6 font-bold text-gray-900 dark:text-gray-100 mb-4">
                      {{ selectedProject.title }}
                    </DialogTitle>
                    <div class="mt-4">
                      <img :src="selectedProject.image" :alt="selectedProject.title"
                        class="w-full h-64 object-cover rounded-lg mb-6">
                      <p class="text-gray-700 dark:text-gray-300 mb-4">{{ selectedProject.fullDescription }}</p>
                      <h4 class="text-xl font-semibold mb-2 text-gray-800 dark:text-gray-200">Key Features:</h4>
                      ...
                      <h4 class="text-xl font-semibold mb-2 text-gray-800 dark:text-gray-200">Technologies Used:</h4>
                      <div class="flex flex-wrap gap-2 mb-4">
...
const allProjects = [
  {
    ...
    fullDescription: "This e-commerce platform offers a comprehensive solution for online retail. It features user authentication, product catalog management, shopping cart functionality, and secure payment integration. The platform is built with scalability in mind, allowing for easy expansion and customization.",
  ...
  },
  {
    ...
    fullDescription: "This task management application allows teams to collaborate efficiently. It offers real-time updates, task assignment, progress tracking, and team communication features. The app is designed to improve productivity and streamline project workflows.",
