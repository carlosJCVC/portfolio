    ...
    <div class="flex-grow flex overflow-hidden">
      ...
      <div class="w-48 bg-[#252526] border-r border-gray-700 p-2 space-y-1">
        <button
          ...
          :class="activeTab === tab.id ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-white/5 hover:text-white'"
      ...
      <div class="flex-grow p-8 overflow-auto">
          ...
          <section>
            ...
            <div class="grid grid-cols-3 gap-4">
              <button
                ...
                :class="store.wallpaper === wp.url ? 'border-blue-500 ring-2 ring-blue-500/50' : 'border-transparent hover:border-gray-500'"
          ...
          <section>
            ...
            <div class="flex gap-4">
              <button
                ...
                :class="store.theme === 'dark' ? 'border-blue-500 bg-blue-500/10 text-blue-400' : 'border-gray-700 hover:border-gray-500'"
        ...
        <div v-if="activeTab === 'about'" class="space-y-6">
          <div class="flex items-center gap-6">
            <div class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-4xl text-white font-bold shadow-xl">
              OS
            </div>
            <div>
...
const wallpapers = [
  { name: 'Cyber Earth', url: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop' },
  { name: 'Deep Space', url: 'https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?q=80&w=2072&auto=format&fit=crop' },
  { name: 'Neon City', url: 'https://images.unsplash.com/photo-1515630278258-407f66498911?q=80&w=1974&auto=format&fit=crop' },
  { name: 'Minimal Dark', url: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?q=80&w=2070&auto=format&fit=crop' },
  { name: 'Code Matrix', url: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=2070&auto=format&fit=crop' },
  { name: 'Abstract Flow', url: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=1964&auto=format&fit=crop' }
]
</script>
