...
export const projects = [
  ...
  },
  {
    ...
    fullDescription:
      'A robust Drupal-based CMS designed for ELFEC to manage their corporate web presence. The system handles complex user roles, public information dissemination, and internal content workflows, providing a stable and scalable platform for the utility company.',
    image: ElfecImage,
  ...
  },
  {
    ...
    description:
      'Credit-based creative workflow platform integrating Shopify payments with a Laravel backend.',
    fullDescription:
      "A comprehensive creative services platform where clients use purchased credits to request design and copywriting work. The system features a seamless integration with Shopify for credit purchases, triggering real-time API updates to the user's balance. It includes a robust role-based workflow where administrators process requests, upload deliverables, and manage iterative revision cycles with clients until approval.",
    image: MoxieMain,
  ...
  },
  {
    ...
    fullDescription:
      'A progressive web application (PWA) designed to engage users in wellness activities. Users upload and stream videos for challenges, workouts, and cooking, which are stored on an external platform to optimize performance. The system gamifies the experience by awarding points based on video engagement and views, fostering a competitive and motivating community.',
  ...
  },
  {
    ...
    fullDescription:
      'A data-driven web application focused on generating detailed performance reports. It automates the calculation of averages, percentages, and evaluation scores (similar to academic grading). The system visualizes these metrics and allows for the export of comprehensive reports, aiding in data analysis and decision-making.',
    image: KtnMain,
  ...
  },
  {
    ...
    fullDescription:
      'A WordPress-based monitoring system for horse racing news and events. The project involved building a custom Python scraping engine to mirror real-time race data, odds, and news from external sources, ensuring the site remained up-to-date with the latest industry information without manual input.',
    image: UsRacingMain,
    ...
    gallery: [{ src: UsRacingMain, caption: 'Live Race Monitor' }]
  },
  {
    id: 6,
    title: 'JaysWideShoes',
    ...
    fullDescription:
      'A critical recovery project for a Magento-based e-commerce store that suffered a cyberattack. The work involved cleaning malicious code, restoring database integrity, and scrubbing "dirty" data from Google search indices. Enhanced security measures were implemented to prevent future breaches and restore customer trust.',
    image: JaysMain,
